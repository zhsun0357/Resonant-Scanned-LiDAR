...
// q_wodom_curr comes from laser odometry process
// q_w_curr is being optimized, from map world to current lidar
// q_wmap_wodom is from map world to odom world
...
void process()
{
	while(1)
	{
			...
			!fullResBuf.empty() && !odometryBuf.empty())
		{
			...
			odom_fname << PCL_DATA_SAVE_DIR << "/odom_" << frameCount << ".txt";
